...
from . import views
from .import HodViews, SupervisorViews, StudentViews
...
urlpatterns = [
    ...
    # # URLS for Staff
    # path('staff_home/', SupervisorViews.staff_home, name="staff_home"),
    ...
    # path('staff_profile/', SupervisorViews.staff_profile, name="staff_profile"),
    # path('staff_profile_update/', SupervisorViews.staff_profile_update, name="staff_profile_update"),
